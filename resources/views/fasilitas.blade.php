        ...
        <div class="row">
            <div class="span12">
                <ul class="portfolio-categ filter">
                    ...
                    @foreach (setting('kategori_tags')['fasilitas'] as $fasilitas)
                        <li class="{{ $fasilitas }}"><a href="#">{{ $fasilitas }}</a></li>
                    @endforeach
                </ul>
                ...
                <div class="row">
                    <section id="projects">
                        <ul id="thumbs" class="grid cs-style-4 portfolio">
                            @foreach (App\Models\Gallery::where('kategori', 'fasilitas')->get() as $gallery)
