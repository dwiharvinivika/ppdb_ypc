								...
								<div class="x_content">
                                    ...
                                    @csrf
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="kode_jurusan" id="first-name" 
													class="form-control @error('kode_jurusan') is-invalid @enderror" value="{{ old('kode_jurusan') }}">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<textarea name="keterangan" class="form-control @error('keterangan') is-invalid @enderror" value="{{ old('keterangan') }}">
                                                   </textarea>
											</div>
										</div>
