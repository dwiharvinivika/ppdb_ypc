			...
			<div class="x_panel">
				...
				<div class="x_content">
					...
					<div class="item form-group">
						<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Gelombang </label>
						<div class="col-md-6 col-sm-6 ">
							{{-- <input type="number" name="tahun_ajaran_id" id="first-name" class="form-control @error('tahun_ajaran_id') is-invalid @enderror" value="{{ old('tahun_ajaran_id') }}"> --}}
