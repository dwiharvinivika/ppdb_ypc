					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form method="post" action="/admin/kegiatan/{{ $kegiatan->id }}" entctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                    @method('patch')
                                    @csrf
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="file" name="gambar" id="last-name" name="last-name" 
													class="form-control @error('gambar') is-invalid @enderror" value="{{ $kegiatan->gambar }}">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="keterangan" id="first-name" 
													class="form-control @error('keterangan') is-invalid @enderror" value="{{ $kegiatan->keterangan }}">
